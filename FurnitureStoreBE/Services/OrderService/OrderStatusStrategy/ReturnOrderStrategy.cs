...
{
    public class ReturnOrderStrategy : OrderActionStrategy
    {
        private readonly ApplicationDBContext _dbContext;
        private readonly IFileUploadService _fileUploadService;
        private readonly IMapper _mappers;
        public ReturnOrderStrategy(ApplicationDBContext dbContext, IFileUploadService fileUploadService, IMapper mappers)
        {
        ...
        public async Task<OrderResponse> UpdateOrderStatus(Order order, UpdateOrderStatusRequest updateOrderStatusRequest)
        {
            ...
            {
                OrderId = order.Id,
                Status = EOrderStatus.ReturnGoods,
