...
{
    public class DeliverOrderToCustomerStrategy : OrderActionStrategy
    {
        private readonly ApplicationDBContext _dbContext;
        private readonly IFileUploadService _fileUploadService;
        private readonly IMapper _mappers;
        public DeliverOrderToCustomerStrategy(ApplicationDBContext dbContext, IFileUploadService fileUploadService, IMapper mappers)
        {
